...
|| # License Type: Commercial License                            $Revision: 258 $ # ||
|| # ---------------------------------------------------------------------------- # ||
|| # 																			  # ||
	...
	*/
	function exec2()
	{
		...
		foreach (array_keys($this->transports) AS $tname)
		{
			...
			else if (($result = $transport->exec()) === VURL_HANDLED AND $this->fetch_error() === VURL_ERROR_MAXSIZE)
			{
				return array('body' => 'VURL_ERROR_MAXSIZE');
			}
...
|| # Version: 4.2.100
|| # $Revision: 259 $
|| # Released: $Date: 2012-10-06 01:34:09 +0200 (Sat, 06 Oct 2012) $
|| ########################################################################### ||
\*============================================================================*/